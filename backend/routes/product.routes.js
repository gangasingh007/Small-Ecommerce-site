...
router.post("/create",productmiddleware, async (req,res)=>{
...
router.put("/update/:id",productdeletemidddleware,async (req,res)=>{
    const {id} = req.params;
...
router.get("/delete/:id",productdeletemidddleware,async(req,res)=>{
    const {id} = req.params;
